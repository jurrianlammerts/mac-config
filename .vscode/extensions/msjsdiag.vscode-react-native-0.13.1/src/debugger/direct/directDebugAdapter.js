...
class DirectDebugAdapter extends vscode_chrome_debug_core_1.ChromeDebugAdapter {
    ...
    launch(launchArgs) {
        ...
        return new Promise((resolve, reject) => this.initializeSettings(launchArgs)
            ...
            return reactNativeProjectHelper_1.ReactNativeProjectHelper.getReactNativeVersion(launchArgs.cwd)
                .then(version => {
    ...
    attach(attachArgs) {
        ...
        return new Promise((resolve, reject) => this.initializeSettings(attachArgs)
            ...
            return reactNativeProjectHelper_1.ReactNativeProjectHelper.getReactNativeVersion(attachArgs.cwd)
                .then(version => {
                extProps = telemetryHelper_1.TelemetryHelper.addReactNativeVersionToEventProperties(version, extProps);
