...
function makeSession(debugSessionClass, debugSessionOpts, telemetryReporter, appName, version) {
    return class extends debugSessionClass {
        ...
        attachRequest(request) {
            ...
            return reactNativeProjectHelper_1.ReactNativeProjectHelper.getReactNativeVersion(request.arguments.cwd)
                .then(version => {
...
function getProjectRoot(args) {
    ...
    try {
        ...
        vscode_chrome_debug_core_1.logger.verbose(`${settingsPath} file doesn't exist or its content is incorrect. This file will be ignored.`);
