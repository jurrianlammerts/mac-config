...
class CommandPaletteHandler {
    ...
    static startPackager() {
        return this.selectProject()
            .then((project) => {
            return reactNativeProjectHelper_1.ReactNativeProjectHelper.getReactNativePackageVersionFromNodeModules(project.packager.getProjectPath())
                .then(version => {
    ...
    static getRunOptions(project, platform, target = "simulator") {
        ...
        commandExecutor_1.CommandExecutor.ReactNativeCommand = settingsHelper_1.SettingsHelper.getReactNativeGlobalCommandName(project.workspaceFolder.uri);
        return runOptions;
    }
}
