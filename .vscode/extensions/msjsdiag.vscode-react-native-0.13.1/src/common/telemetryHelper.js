...
class TelemetryHelper {
    ...
    static addReactNativeVersionToEventProperties(reactNativeVersion, properties = {}) {
    ...
    static sendErrorEvent(eventName, error, isPii = true) {
    ...
    static sendDirect(eventName, properties) {
    ...
    static generate(name, extendedParamsToSend = {}, codeGeneratingTelemetry) {
        let generator = new telemetryGenerators_1.TelemetryGenerator(name, extendedParamsToSend);
