...
class CommandExecutor {
    ...
    getReactNativeVersion() {
        return reactNativeProjectHelper_1.ReactNativeProjectHelper.getReactNativeVersion(this.currentWorkingDirectory);
    }
    /**
    ...
    spawnReactCommand(command, args = [], options = {}) {
        const reactCommand = hostPlatform_1.HostPlatform.getNpmCliCommand(this.selectReactNativeCLI());
    ...
    static getCommandStatusString(command, status) {
        switch (status) {
            ...
            default:
                throw errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.UnsupportedCommandStatus);
        }
    }
}
