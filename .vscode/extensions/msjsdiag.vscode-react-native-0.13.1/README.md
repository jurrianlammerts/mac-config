...
![Add React Native debug configuration](https://github.com/Microsoft/vscode-react-native/raw/master/images/add-debug-configuration.gif)
...
![React Native enable remote debug](https://github.com/Microsoft/vscode-react-native/raw/master/images/enable-remote-debug.png)
...
We support using Expo to run, debug and publish applications. For more details about configuring and debugging Expo applications see [Expo docs](https://github.com/Microsoft/vscode-react-native/blob/master/doc/expo.md)
